...
![Original and augmented images reconstructed after PCA dimension reductio, processed in pca.py.](reconstruction_comparison.png){#fig-pca width=60%}
...
![Shiny application pages 1 to 3, larger pictures can be found in the appendix](app_pics/overview.png)
