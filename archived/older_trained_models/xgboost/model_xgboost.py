...
def train_and_evaluate_xgboost(folder='original', n_components=100, save_pca=False, load_pca=True):
    base_path = f"{folder}"
    ...
    xgb_model.save_model(f'xgboost_{folder}.json')
    ...
    with open(csv_file, 'a', newline='') as csvfile:
        fieldnames = ['folder', 'accuracy', 'f1_score', 'training_time']
...
train_and_evaluate_xgboost(folder='blur1', save_pca=True, load_pca=False)
